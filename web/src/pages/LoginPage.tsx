  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-sm w-full text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Flowstate</h1>
        <p className="text-gray-500 mb-8">
          Your Slack messages, ranked by what matters to you.
        </p>
        <button
          onClick={login}
          className="inline-flex items-center gap-3 px-6 py-3 text-white bg-[#4A154B] rounded-lg hover:bg-[#3a1039] transition-colors font-medium shadow-sm"
        >
